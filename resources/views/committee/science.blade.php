...
<section id="depart" class="book pb-5">
    <div class="row ">
        ...
        <div class="About col-lg-8 text-center  mt-5 mb-5  p-5">
            <h1 class="m-2 mb-4 p-2">الأنشطة اللجنة العلمية</h1>
            <p dir="rtl">تختص اللجنة العلمية بنشر الوعي العلمي و الثقافي بين طالبات الكلية وتنمية القدرات الذهنية من خلال تكوين فرق علمية مختلفة مثل فريق الابتكار ، الكمبيوتر ، الأبحاث العلمية .</p>
    ...
    <div class="container ">
        <div class="row text-center">
            <div class="item col-lg-6">
                <img src="image/5141358.jpg" width="400" height="250" alt="user1">
                <P>ندوات علمية</P>
            </div>
            <div class="item col-lg-6">
                <img src="image//7et2_hnax_210901.jpg" width="400" height="250" alt="user2">
                <P>مسابقات علمية (اختراعات و ابتكارات)</P>

            </div>
            <div class="item col-lg-6">
                <img src="image/travel-elements.jpg" width="400" height="250" alt="user1">
                <P>رحلات علمية</P>
            </div>
            <div class="item col-lg-6">
                <img src="image/chemical-bond.jpg" width="400" height="250" alt="user3">
                <P>دورات علميه</P>
