...
<section id="depart" class="book pb-5">
    <div class="row ">
        ...
        <div class="About col-lg-8 text-center  mt-5 mb-5  p-5">
            <h1 class="m-2 mb-4 p-2">الأنشطة اللجنة الفنية</h1>
    ...
    <div class="container ">
        <div class="row text-center">
            <div class="item col-lg-3">
                <img src="image/953.jpg" width="300" height="250" alt="user1">
                <P>المهرجان المسرحي</P>
            </div>
            <div class="item col-lg-3">
                <img src="image/top-view-sewing-thread-with-measuring-tape-scissors.jpg" width="300" height="250" alt="user2">
                <P>معرض مشغولات يدوية</P>

            </div>
            <div class="item col-lg-3">
                <img src="image/high-paint-b.jpg" width="300" height="250" alt="user1">
                <P>مسابقات رسم</P>
            </div>
            <div class="item col-lg-3">
                <img src="image/camera-photographic.jpg" width="300" height="250" alt="user3">
                <P>مسابقات تصوير</P>
            </div>
            <div class="item col-lg-3">
                <img src="image/high-paint-b.jpg" width="300" height="250" alt="user3">
                <P>ورشة رسم</P>
            </div>
            <div class="item col-lg-3">
                <img src="image/colored-tile-pattern-street.jpg" width="300" height="250" alt="user3">
                <P>رسم علي الاسفلت</P>
            </div>
            <div class="item col-lg-3">
                <img src="image/people-directing-new-movie-together.jpg" width="300" height="250" alt="user3">
                <P>ورشة تمثيل</P>
            </div>
            <div class="item col-lg-3">
                <img src="image/vintage-microphone-musical-instruments-red-neon-lights.jpg" width="300" height="250" alt="user3">
                <P>غناء</P>
            </div>
        </div>
    </div>
