...
<head>
    ...
    <!--title of page-->
    <title>لجنة الاسر الطلابية</title>
...
<section id="depart" class="book pb-5">
    <div class="row ">
        ...
        <div class="About col-lg-8 text-center  mt-5 mb-5  p-5">
            <h1 class="m-2 mb-4 p-2">الأنشطة لجنة الاسر الطلابية </h1>
    ...
    <div class="container text-center ">
        <div class="row ">
            <div class="item col-lg-6">
                <img src="image/hand-playing-chess-classic-board.jpg" class="w-100" alt="user1">
                <P>شطرنج</P>
            </div>

            <div class="item col-lg-6">
                <img src="image/table-tennis-ping-pong.jpg" class="w-100 " alt="user1">
                <P>تنس طاوله</P>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="item col-lg-8">
                <img src="image/eventshub_evergreen_opengraph_1200x630_2x.jpg" class="w-100" alt="user3">
                <P>أحداث خاصه بالفرق المسجله بالكلية</P>
            </div>
        </div>
    </div>
</section>
